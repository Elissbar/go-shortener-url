...
// При попытке сохранить уже существующую запись возвращает ошибку и старый токен (oldToken, repository.ErrURLExists).
//
// В случае сохранения нового токена возвращает его же.
...
// SaveBatch с помощью транзакции сохраняет в БД батч записей.
...
// DeleteByTokens маркирует записи как удаленные.
