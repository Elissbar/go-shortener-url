...
// 	protoc        v7.34.0
// source: internal/grpc/shortener.proto
...
func (x *URLShortenRequest) Reset() {
	*x = URLShortenRequest{}
	mi := &file_internal_grpc_shortener_proto_msgTypes[0]
...
func (x *URLShortenResponse) Reset() {
	*x = URLShortenResponse{}
	mi := &file_internal_grpc_shortener_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *URLExpandRequest) Reset() {
	*x = URLExpandRequest{}
	mi := &file_internal_grpc_shortener_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *URLExpandResponse) Reset() {
	*x = URLExpandResponse{}
	mi := &file_internal_grpc_shortener_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *UserURLsResponse) Reset() {
	*x = UserURLsResponse{}
	mi := &file_internal_grpc_shortener_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *URLData) Reset() {
	*x = URLData{}
	mi := &file_internal_grpc_shortener_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_internal_grpc_shortener_proto protoreflect.FileDescriptor

const file_internal_grpc_shortener_proto_rawDesc = "" +
	"\n" +
	"\x1dinternal/grpc/shortener.proto\x12\tshortener\x1a\x1bgoogle/protobuf/empty.proto\"%\n" +
	...
	"\fListUserURLs\x12\x16.google.protobuf.Empty\x1a\x1b.shortener.UserURLsResponseBAZ?github.com/Elissbar/go-shortener-url/grpc_shortener;shortenerpbb\beditionsp\xe8\a"

var file_internal_grpc_shortener_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_internal_grpc_shortener_proto_goTypes = []any{
...
var file_internal_grpc_shortener_proto_depIdxs = []int32{
...
func init() { file_internal_grpc_shortener_proto_init() }
func file_internal_grpc_shortener_proto_init() {
	if File_internal_grpc_shortener_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_internal_grpc_shortener_proto_rawDesc), len(file_internal_grpc_shortener_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_internal_grpc_shortener_proto_goTypes,
		DependencyIndexes: file_internal_grpc_shortener_proto_depIdxs,
		MessageInfos:      file_internal_grpc_shortener_proto_msgTypes,
	}.Build()
	File_internal_grpc_shortener_proto = out.File
	file_internal_grpc_shortener_proto_goTypes = nil
	file_internal_grpc_shortener_proto_depIdxs = nil
}
